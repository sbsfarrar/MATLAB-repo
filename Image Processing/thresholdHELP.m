function [lowThreshold,highThreshold] = thresholdHELP(fullFileName)
% Demo to threshold and mask a double or integer image.
...
% folder = fileparts(which('N116 18SEP2022 4X.tif')); % Determine where demo folder is (works with all versions).
% baseFileName = 'N116 18SEP2022 4X.tif';
